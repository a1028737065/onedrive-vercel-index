...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'a@hinatazaka46.onmicrosoft.com',
  ...
  protectedRoutes: ['/picture/graduation', '/🥟 Some test files/Protected route'],
